...
import MultiSelectTagDropdown from "../../select-dropdown/MultiSelecetTagDropdown";
import { getAllCategories } from "../../../../../services/index/postCategories";
import { categoryToOption, filterCategories } from './../../../../../utils/multiSelectTagUtils';
import EditorForUpdate from "../../../../../components/editor/EditorForUpdate";
...
const EditPost = () => {
    ...
    const { data, isLoading, isError } = useQuery({
        ...
        queryKey: ["blog", slug],
        onSuccess: (data) => {
            setInitialPhoto(data?.data.photo);
                    ...
                    <article className="flex-1">
                        ...
                        <div className="d-form-control w-full">
                            ...
                            <input
                                id="title"
                                value={title}
                                className="d-input d-input-bordered border-slate-300 !outline-slate-300 text-xl font-medium font-roboto text-dark"
